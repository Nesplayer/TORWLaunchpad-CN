...
public class PlayerGradientData(IntPtr ptr) : MonoBehaviour(ptr)
{
    ...
    public bool GradientEnabled
    {
        get
        {
            ...
            Logger<TORWLPlugin>.Warning($"No gradient data found for id {playerId}, player: {(bool)player}!");
            return _gradientEnabled;
        }
    ...
    public int GradientColor
    {
        get
        {
            ...
            Logger<TORWLPlugin>.Error($"No gradient color found for id {playerId}, player: {(bool)player}!");
